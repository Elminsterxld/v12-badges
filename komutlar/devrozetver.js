...
if(message.author.id !== '754092428557942855') if(message.author.id !== '754092428557942855') return message.channel.send(`Üzgünüm Sen \`Elminstêr\` Değilsin!`)
  ...
  db.set(`memberBadge_${nesne}`,'onyr')
  
  message.channel.send(` <@${nesne}> adlı kişinin Developer Rozetini başarıyla verdim!`)

if (client.users.cache.get(''+nesne+'').send(` \`Developer Rozetiniz başarıyla Verildi!\` `)){
